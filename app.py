...
from blueprints.comunes import comun_bp
...
#Creo la app
app = Flask(__name__)
#Le aplico la proteccion a la CSRF
csrf = CSRFProtect(app)

# AQUÍ - Deshabilitar CSRF temporalmente
app.config['WTF_CSRF_ENABLED'] = False  # Temporal mientras resolvemos

# Función para excluir rutas API
@app.before_request
def csrf_check():
...
#Conexion a comunes
app.register_blueprint(comun_bp)
